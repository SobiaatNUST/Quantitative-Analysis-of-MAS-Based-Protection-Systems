...
module DG1
	...
	// 0: Zero current
	// 1: Non-zero current
	[a] (DG1=0&IDG1=0&FC2=1)  ->    0.5: (DG1'=1)&(IDG1'=0)
		    			               +0.5:(DG1'=2)&(IDG1'=1);
endmodule

// construct remaining modules through renaming
module DG2 = DG1[a=a,IDG1=IDG2,DG1=DG2,FC2=FC2]endmodule
module DG3 = DG1[a=a,IDG1=IDG3,DG1=DG3,FC2=FC2]endmodule
module DG4 = DG1[a=a,IDG1=IDG4,DG1=DG4,FC2=FC2]endmodule
...
module SW
	...
	[] sw=0&(DG1>0&DG2>0&DG3>0&DG4>0) ->   0.5:(sw'=1)&(ISW_F'=0)
			                      +0.5:(sw'=2)&(ISW_F'=ICB3_F+IDG3+IDG4+ICB4_F);	endmodule
...
module CB1
	...
	[] (b1=0&BC1=0)&(sw=1|sw=2)&(DG1>0&DG2>0&DG3>0&DG4>0)  ->  0.5:(b1'=1)&(ICB1_F'=0)		                   				                  +0.5:(b1'=2)&(ICB1_F'=IMG);
...
module CB3
	...
	// 3: Fail to open
        // Breaker can be open or close initially 
	[] (b3=0&BC3=0)&((sw=1&b1=2)|b1=1)&(DG1>0&DG2>0&DG3>0&DG4>0)  ->  0.5: (b3'=1)& (ICB3_F'=0)
			                   		                         +0.5:(b3'=2)& (ICB3_F'=IMG);
...
module R1
	...
	[ft1] (r1=5)&(CTM2=2)&(s2=5|TL_R1=2)  ->  1-IED:(r1'=1)
			                           +IED:(r1'=2);
...
module R2
	...
	[ft1] (r2=5& TL2=0&WD2=2)  ->  1-IED:(r2'=1)
			               +IED:(r2'=2);
	//When CTM2=2 and TL not received by R3
...
module R3
	...
	[] (r3=0&sel3=4&FC2=1)&(r3_nbr<z_nbr)&(b3=2)&(sw=2)&(b1>0&b2>0&b4>0)  
                                ->  (IR3_F'=ICB3_F)&(sel3'=-(r3_nbr-z_nbr));
	[] (r3=0&sel3=1&IR3_F>0)&(b1>0&b2>0&b3=2&sw=2&b4>0)  
					        -> (r3'=5); 
	[] (r3=0)&(sel3=4|sel3=1)&(IR3_F=0)&((b3=1)&b2>0&b1>0&sw>0&b4>0)  
					        -> (r3'=6);
	[] (r3=0)&(sel3=4|sel3=1)&(IR3_F=0)&((b3=2)&b2>0&b1>0&sw=1&b4>0)  
			       -> (r3'=6);
	// Operation mode        
	[lok2] (r3=5&s2=1)&(CTM2=2|CTM2=3)&(TL_R3=1)  ->  (r3'=3);
...
module Watchdog2
	...
	[] (WD2=0&CTM2=0)&((r2=5&sel2=0&r3=6& r1=5& sel1=1&(r4=6|r4=5))
		         |(r2=5&sel2=0&r1=6&r3=5& sel3=1&(r4=6|r4=5)))
					 		->    1-WD:(WD2'=2)
		           		     +WD:(WD2'=1); 
endmodule
...
module Sig_Disp2
	...
	//4: TRQ1 not sent
        ...
        [] (s2=0&((r1=5&r2=5)
		|(r2=5&r3=5))&(CTM2=2|CTM2=3))  -> 1-COM:(s2'=1)
						                           +COM:(s2'=5); 
	[prim] ((r1=3)&TL2=0&(CTM2=2|CTM2=3))  -> (s2'=2);
	[prim2] ((r3=3)&TL2=0&(CTM2=2|CTM2=3))  -> (s2'=2);
...
// construct remaining modules through renaming
module   Sig_Rcv3 = Sig_Rcv1[TL_R1=TL_R3,s2=s2,TRQ_R1=TRQ_R3,IR1_F=IR3_F] endmodule
module   Sig_Rcv4 = Sig_Rcv1[TL_R1=TL_TRQ_R4,s2=s2,TRQ_R1=TRQ_R4,IR1_F=IR4_F] endmodule
...
// construct remaining modules through renaming 
module sup_sv3 =sup_sv1[r2=r2,BC2=BC2,WD2=WD2,CTM2=CTM2,sv1=sv3,t1=t3,TRQ_R1=TRQ_R3,TL1=TL3,b2=b2,r1=r3,FC2=FC2,BC1=BC3,IR1_F=IR3_F] endmodule
module sup_sv4 =sup_sv1[WD2=WD2,CTM2=CTM2,sv1=sv4,t1=t4,TRQ_R1=TRQ_R4,TL1=TL4,b2=b2,r1=r4,FC2=FC2,BC1=BC4,IR1_F=IR4_F] endmodule
...
label "Cond1"=  FC2=1 & (r1=5&r2=5&r3=6)&((WD2=2&(CTM2=2|CTM2=3))|(WD2=1));

label "Cond2"=  FC2=1 & (r3=5&r2=5&r1=6)&((WD2=2&(CTM2=2|CTM2=3))|(WD2=1));
...
label "WD1"=(r1=5&sel1=1)&(r2=5&sel2=0&r3=6) ;
label "WD2" = (r2=5&sel2=0&r1=6)&(r3=5&sel3=1);
