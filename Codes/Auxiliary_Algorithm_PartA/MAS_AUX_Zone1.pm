...
module Watchdog1
	...
	[] (WD1=0&CTM1=0&r1=5&sel1=0&r2=5&sel2=1&sel4=3)  ->  1-WD: (WD1'=2)
			                                    + WD: (WD1'=1);
endmodule
...
module Watchdog2
	...
	[] (WD2=0&CTM2=0&r2=5&sel2=1&r1=6&r3=5&sel3=2&sel4=3)->  1-WD:(WD2'=2)
			                                        +WD:(WD2'=1);
...
// constructing remaining modules through renaming 
module Sig_Rcv3 = Sig_Rcv2[s1=s2,TRQ_R2=TRQ_R3,IR2_F=IR3_F] endmodule
module Sig_Rcv4 = Sig_Rcv2[s1=s2,TRQ_R2=TRQ_R4,IR2_F=IR4_F] endmodule
...
module sup_sv2
	...
	[] (sv2=0&t2=false)&(TRQ_R2=2|TL2=1|(r2=2&(b1=2|b1=3)))&(IR2_F>0)  ->   0.5:(t2'=true)
					                 				                               +0.5:(t2'=false);
	[] (sv2=0&t2=false&BC2=2)&(b1=2|b1=3)&(IR2_F>0)  ->  0.5:(t2'=true)
					          	                    +0.5:(t2'=false); 
	[] sv2=0 & t2=true -> (sv2'=1);     
endmodule
...
// constructing remaining modules through renaming 
module sup_sv3 = sup_sv2[sv2=sv3,t2=t3,TRQ_R2=TRQ_R3,TL2=TL3,b1=b2,r2=r3,FC1=FC1,BC2=BC3,IR2_F=IR3_F] endmodule
