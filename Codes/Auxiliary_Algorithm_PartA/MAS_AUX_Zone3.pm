...
module Watchdog3
	...
	[] (WD3=0&CTM3=0)&(r2=5&sel2=1&r3=5&sel3=0&sel4=1)
					->  1-WD:(WD3'=2)
		            +WD:(WD3'=1); 
endmodule
...
module Watchdog2
	...
	[] (WD2=0&CTM2=0)&(r2=5&sel2=1&r3=6&r1=5&sel1=2&sel4=1)
						->   1-WD:(WD2'=2)
		             +WD:(WD2'=1); 
endmodule
...
module Sig_Disp3 = Sig_Disp2[s2=s3,CTM2=CTM3,r1=r2,TL2=TL3,WD2=WD3,r2=r3,BC2=BC3,b2=b3,
                    lock2=lock3,opr=opr3,TRQ2=TRQ3,req2=req3]endmodule
...
// construct remaining modules through renaming 
module   Sig_Rcv2 = Sig_Rcv1[s2=s3,TRQ_R1=TRQ_R2,IR1_F=IR2_F] endmodule
module   Sig_Rcv4 = Sig_Rcv1[s2=s3,TRQ_R1=TRQ_R4,IR1_F=IR4_F] endmodule
...
// construct remaining modules through renaming
module sup_sv2 = sup_sv1[sv1=sv2,t1=t2,TRQ_R1=TRQ_R2,TL1=TL2,b2=b3,r1=r2,FC3=FC3,BC1=BC2,IR1_F=IR2_F] endmodule
...
label "Fail1"  = ((WD3=2 &(CTM3=2|CTM3=3) & (r3=1& BC3=1 & b3=3 & b2=3)|(r3=1& BC3=2 & b2=3)|(r3=2& b2=3))
			|(WD3=1& b2=3&(s3=3|s3=4)));
label "Fail2"=((WD2=2&(CTM2=2|CTM2=3) & (r2=1& BC2=1 & b2=3 & b1=3)|(r2=1& BC2=2 & b1=3)|(r2=2& b1=3))
