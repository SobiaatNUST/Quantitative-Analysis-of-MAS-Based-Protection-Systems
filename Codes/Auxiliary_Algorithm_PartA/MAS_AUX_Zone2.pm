...
module R2
	...
	[opr2] (r2=5&TL2=0&WD2=2) ->  1-IED:(r2'=1)
			               +IED:(r2'=2);
	[opr3] (r2=5&TL2=0&WD2=2) ->  1-IED:(r2'=1)
			               +IED:(r2'=2);
	// Breaker signal sent or not
...
module R4
	...
	[] (r4=0&sel4=2&IR4_F=0)&(b1>0&b2>0&b4=2&sw>0&b3>0)  
					            -> (r4'=6);
	// Operation mode       
	[lock3] (r4=5&s2=0&(CTM2=2|CTM2=3))  ->  (r4'=3);
...
module Sig_Disp2
	...
	[lock]  (s2=0&r1=5&r2=5&(CTM2=2|CTM2=3))  ->  (s2'=1); 
	[opr] (s2=1&r1=3&TL2=0&(CTM2=2|CTM2=3))  ->  (s2'=2);
	[lock2] (s2=0&r3=5&r2=5&(CTM2=2|CTM2=3))  ->  (s2'=1); 
	[opr2](s2=1&r3=3&TL2=0&(CTM2=2|CTM2=3))  ->  (s2'=2);
	[lock3] (s2=0&r4=5&r2=5&(CTM2=2|CTM2=3))  ->  (s2'=1); 
	[opr3](s2=1&r4=3&TL2=0&(CTM2=2|CTM2=3)) ->  (s2'=2);
