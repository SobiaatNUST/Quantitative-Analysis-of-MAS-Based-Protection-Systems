...
module Fault
        [] (FC3=0)&(b1=0&b2=0&b3=0&b4=0)  ->  (FC3'=1)&(z_nbr'=3);
...
module CB1
	...
	[] (b1=2&BC1=1&FC3=1)  ->  1-BRK:(b1'=1)&(isol'=true)
							           +BRK:(b1'=3)&(isol'=false);
...
module CB2
	...
	// Relay has sent command to breaker	
	[] (b2=2&BC2=1&FC3=1)  ->  1-BRK:(b2'=1)&(isol'=true)
			           +BRK:(b2'=3)&(isol'=false); 
...
module CB3
	...
	[] (b3=0&sw=2&b1=2)&(DG1>0&DG2>0&DG3>0&DG4>0)  ->  (b3'=1)&(ICB3_F'=0);
     ...
     // Relay has sent command to breaker							                        
	[] (b3=2&BC3=1&FC3=1)  -> 1-BRK:(b3'=1)&(isol'=true)
							          +BRK:(b3'=3)&(isol'=false);
...
// Relay current values
	...
	[] (r1=5&(WD2=1|(CT2=1&(r2=2|b2=3))))&(FC3=1)  ->  1-IED:(r1'=1)&(BC1'=1)
			          			           +IED:(r1'=2)&(BC1'=2);
	// tb<<tp
	[ft2] (r1=5&CT2=2&FC3=1)  ->  1-IED:(r1'=1)&(BC1'=1)
			              +IED:(r1'=2)&(BC1'=2);
	// tb>>tp
	[] (r1=5&(CT2=3&(r2=2|b2=3)))&(FC3=1)  ->  (r1'=4)&(risk'=true);    
...
module R2
	...
	[] (r2=5&FC3=1)&(WD3=1|(WD3=2&CT3=1&(r3=2|b3=3)))  ->  1-IED:(r2'=1)&(BC2'=1)
			          				               +IED:(r2'=2)&(BC2'=2);
	//tb<<tp
	[ft1] (r2=5&CT3=2&FC3=1)  ->  1-IED:(r2'=1)&(BC2'=1)
			              +IED:(r2'=2)&(BC2'=2);
	//tb>>tp
	[] (r2=5&(CT3=3&(r3=2|b3=3)))&(FC3=1)  ->  (r2'=4)&(risk'=true);

	/// Timer check for CTM=3
	[] r2=4& t2=false -> 0.5:(t2'=true)&(r2'=4)+0.5:(t2'=false)&(r2'=4);

	// Operation R2 act as main and R1 as backup relay
	[] (r2=5&WD2=2&(CT2=1|CT2=3))&(FC3=1)  ->  1-IED:(r2'=1)&(BC2'=1)
			          		   +IED:(r2'=2)&(BC2'=2);
	[ft2] (r2=5&WD2=2&(CT2=2))&(FC3=1)  ->  1-IED:(r2'=1)&(BC2'=1)
			                        +IED: (r2'=2)&(BC2'=2); 
...
module R3
	...
	[] (r3=0&sel3=4&IR3_F=0)&((b3=1)&b2>0&b1>0&sw>0&b4>0)  
			 -> (r3'=6);
	// Operation 
	[] (r3=5&r2=5&WD3=2)&(CT3=1|CT3=3)&(FC3=1)  ->  1-IED:(r3'=1)&(BC3'=1)
			                                +IED:(r3'=2)&(BC3'=2);

	[ft1] (r3=5&(r2=5)&WD3=2&(CT3=2))&(FC3=1)  -> 1-IED:(r3'=1)&(BC3'=1)
			                              +IED:(r3'=2)&(BC3'=2);
endmodule
...
module R4
	...
	[] (r4=0&sel4!=4&IR4_F>0)&(b1>0&b2>0&b4=2&sw>0&b3>0)  
					          -> (r4'=5); 
	[] (r4=0&sel4=4&IR4_F=0)&(FC3=1)&(b1>0&b2>0&(b4=1|b4=2)&sw>0&b3>0)  
					          -> (r4'=6);
...
label "Succ1" =  (b3=1|b2=1)&(isol=true);
label "Succ2" =  (b2=1|b1=1)&(isol=true);

label "Cond1"= FC3=1 &(r2=5& r3=5&(r4=6|sel4=1)&(r1=6|sel1=2));
label "Succa"= (CT3=1|CT3=3)&((r3=1 &b3=1 & isol=true)
		  |(r2=1&b2=1& isol=true))
		  |((CT3=2& r2=2& r3=1&b3=1)
                  |(CT3=2& r2=1&b2=3& r3=1&b3=1))
		  |(WD3=1& (r2=1&b2=1));
   
label "Cond2"= FC3=1&(r2=5& r1=5&(r4=6|sel4=1)&(r3=6|sel3=0));              
...
label "Fail1"  = (WD3=2&(((b3=3& b2=3)
		       |(r3=1&b3=3&r2=2))  
		       |(r3=2& b2=3)|(r3=2&r2=2)))    
		       |(WD3=1& (r2=2|(r2=1&b2=3)));   
label "Fail2"=(WD2=2&(((b1=3&b2=3)
				|(r2=1& b2=3&r1=2))
				|(r2=2& b1=3)|(r2=2&r1=2)))
			|(WD2=1& (r1=2|(r1=1&b1=3)));
  
label "False_trip"=(CT3=2&r3=1&r2=1)|(CT2=2&r2=1&r1=1);
label "Risk"= ((CT3=3&r2=4&t2=true)|(CT2=3&r1=4&t1=true))&risk=true;
