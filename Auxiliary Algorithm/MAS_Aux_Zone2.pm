...
module R3
 ...
 module R4
	...
	[] (r4=0&sel4=2&IR4_F=0)&(b1>0&b2>0&b4=2&sw>0&b3>0)   -> (r4'=6);
					           
	// Operation mode       
	[lok3] (r4=5&s2=0&CT2=2)  ->  (r4'=3);
...
module Watchdog2
	...
	[] (WD2=0&CT2=0)&((r2=5&sel2=0&r3=6& r1=5& sel1=1&(r4=6))
...
module Sig_Disp2
	...
	[lok]  (s2=0&r1=5&r2=5&CT2=2)  ->  (s2'=1); 
	[prim] (s2=1&r1=3&TL2=0&CT2=2)  ->  (s2'=2);
	[lok2] (s2=0&r3=5&r2=5&CT2=2)  ->  (s2'=1); 
	[prim2](s2=1&r3=3&TL2=0&CT2=2)  ->  (s2'=2);
	[lok3] (s2=0&r4=5&r2=5&CT2=2)  ->  (s2'=1); 
	[prim3](s2=1&r4=3&TL2=0&CT2=2) ->  (s2'=2);
...
// construct remaining modules through renaming
module   Sig_RCV3 = Sig_RCV1[s2=s2,rcv1=rcv3,IR1_F=IR3_F] endmodule
module   Sig_RCV4 = Sig_RCV1[s2=s2,rcv1=rcv4,IR1_F=IR4_F] endmodule
...
// construct remaining modules through renaming 
module sup_sv3 =sup_sv1[sv1=sv3,t1=t3,rcv1=rcv3,TL1=TL3,b2=b2,r1=r3,FC2=FC2,BC1=BC3,IR1_F=IR3_F] endmodule
module sup_sv4 =sup_sv1[sv1=sv4,t1=t4,rcv1=rcv4,TL1=TL4,b2=b2,r1=r4,FC2=FC2,BC1=BC4,IR1_F=IR4_F] endmodule



// LABELS FOR PROPERTIES VERIFICATION

label "Succ1"= (FC2=1&((b1=1 & isol=true)|(b2=1& isol=true)));
label "Cond1"=  FC2=1 & (r1=5&r2=5);

label "Succ2"= (FC2=1&((b2=1 & isol=true)|(b3=1& isol=true)));
label "Cond2"=  FC2=1 & (r3=5&r2=5);

label "Fail1"  = ((WD2=2 &CT2=2 & (r2=1& BC2=1 & b1=3 & b2=3)|(r2=1& BC2=2 & b1=3)
		 |(r2=2& b1=3))|(WD2=1& b1=3&(s2=3|s2=4)));
			
label "Fail2"=((WD2=2&CT2=2 & (r2=1& BC2=1 & b2=3 & b3=3)|(r2=1& BC2=2 & b3=3)
