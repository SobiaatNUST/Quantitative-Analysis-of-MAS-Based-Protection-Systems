...
module Watchdog1
	...
	[] (WD1=0&CT1=0&r1=5&sel1=0&r2=5&sel2=1&sel4=3)  ->  1-WD: (WD1'=2)
			                                    + WD: (WD1'=1);
 ...
 module Watchdog2
	...
	[] (WD2=0&CT2=0&r2=5&sel2=1&r1=6&r3=5&sel3=2&sel4=3)->  1-WD:(WD2'=2)
			                                        +WD:(WD2'=1);
...
// construct remaining modules through renaming 
module Sig_RCV3 = Sig_RCV2[s1=s2,rcv2=rcv3,IR2_F=IR3_F] endmodule
module Sig_RCV4 = Sig_RCV2[s1=s2,rcv2=rcv4,IR2_F=IR4_F] endmodule
...
// construct remaining modules through renaming 
module sup_sv3 = sup_sv2[sv2=sv3,t2=t3,rcv2=rcv3,TL2=TL3,b1=b2,r2=r3,FC1=FC1,BC2=BC3,IR2_F=IR3_F] endmodule
module sup_sv4 = sup_sv2[sv2=sv4,t2=t4,rcv2=rcv4,TL2=TL4,b1=b2,r2=r4,FC1=FC1,BC2=BC4,IR2_F=IR4_F] endmodule


// LABELS FOR PROPERTIES VERIFICATION
label "Cond1"= (FC1=1&r1=5&r2=5);
label "Succ1"= (FC1=1&((b1=1&isol=true)|(b2=1&isol=true)));

label "Cond2"= (FC1=1&r2=5&r3=5&r1=6);
label "Succ2"= (FC1=1&((b2=1&isol=true)|(b3=1&isol=true)));

label "Fail1"= ((WD1=2&CT1=2&(r1=1&BC1=1&b1=3&b2=3)
	       |(r1=1&BC1=2&b2=3)|(r1=2&b2=3))|(WD1=1&b2=3&(s1=3|s1=4)));
label "Fail2"=((WD2=2&CT2=2&(r2=1&BC2=1&b2=3&b3=3)
